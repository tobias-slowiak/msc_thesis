...
\begin{frame}{Validation: Unsampled membranes}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{itemize}[<+(1)->]
      ...
      \item Agreement is within experimental error bounds of the experimental data.
    \end{itemize}
    \vspace{0.15cm}
    \begin{block}<+(1)->{Good News}
      The model accurately reproduces the measured eigenfrequencies of unsampled membranes.
    \end{block}
